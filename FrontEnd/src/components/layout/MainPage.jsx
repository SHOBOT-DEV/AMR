...
import Sidebar from "../../../../../../../SHOBOT/Software/Phase-2/AMR/AMR/FrontEnd/src/components/SideBar";
import JoyStick from "../../../../../../../SHOBOT/Software/Phase-2/AMR/AMR/FrontEnd/src/components/JoyStick";
...
import { fetchWithAuth, clearAuthTokens, API_BASE } from "../../../../../../SHOBOT/Software/Phase-2/AMR/AMR/FrontEnd/src/utils/auth";
import {
  connectBridgeSocket,
  fetchBridgeStatus,
  sendCmdVel,
} from "../../../../../../SHOBOT/Software/Phase-2/AMR/AMR/FrontEnd/src/utils/amrBridge";
import "./MainPage.css";
...
const MainPage = () => {
  ...
  // add or reuse any handlers/state expected by Header (use existing handlers when present)
  // For compatibility, ensure we have a simple handleLogout if none exists
  const handleLogout = useCallback(() => {
    try {
      // best-effort logout: clear tokens if available and navigate to login
      // (clearAuthTokens import may not be present in this file; if available prefer that)
      if (typeof window !== "undefined") {
        // try best-effort token clear
        try {
  ...
  return (
    ...
    >
      {/* Header moved to dedicated component */}
      <Header
        bridgeStatus={bridgeStatus}
        startBridgeConnection={typeof startBridgeConnection !== "undefined" ? startBridgeConnection : () => {}}
        emergencyClicked={emergencyClicked}
        handleEmergencyToggle={handleEmergencyToggle}
        isLocked={isLocked}
        handleToggleLock={typeof handleToggleLock !== "undefined" ? handleToggleLock : () => {}}
